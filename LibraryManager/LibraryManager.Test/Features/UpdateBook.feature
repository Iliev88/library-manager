...
Scenario Outline: Update a book
	...
	When the book is updated <Id>, <AuthorEdit>, <TitleEdit>, <DescriptionEdit>
	Then successful status code should be returned
	And updated book should be returned as well
Examples:
	| Id | Author | Title       | Description                          | AuthorEdit | TitleEdit | DescriptionEdit |
	| 8  | Miguel | Don Quixote | Alonso Quixano, a retired country... | edit       | edit      | edit            |
